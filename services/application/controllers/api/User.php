...
class User extends BD_Controller {
    ...
    function index_post() {        
        ...
        if($pil == 1){
            ...
            $successLogin = ['status' => 'Success Login']; //Respon if login valid
            ...
            if($p == $match){  //Condition if password matched
                ...
                $this->set_response($successLogin, REST_Controller::HTTP_OK); //This is the respon if success
            }
            else {
            ...
            $insert_pelamar = $this->M_user->registrasiPelamar($id_pelamar, $id_pengguna, $nama, $jk, $alamat, $tempat_lahir, $tanggal_lahir, $agama, $status);
            ...
            $insert_pengguna = $this->M_user->registrasiPengguna($id_pengguna, $username, $email, $password, $role);
            $insert_pekerja = $this->M_user->registrasiPerusahaan($id_perusahaan, $id_pengguna, $nama, $alamat, $telepon, $jenis);
