                                    ...
                                    <table class="table table-hover table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item['nama_pengalaman_kerja']}}</td>
                                                <td>{{$item['waktu_pengalaman_kerja']}}</td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <form action="{{url('postVerify')}}" method="post">
                                                        @csrf
                                                        <input type="hidden" name="halaman" id="halaman" value="adminPengalaman">
                                                        <input type="hidden" name="id_dokumen" id="id_dokumen" value="{{$item['id_pengalaman_kerja']}}">
                                                        <input type="hidden" name="tipe_dokumen" id="tipe_dokumen" value="2">
