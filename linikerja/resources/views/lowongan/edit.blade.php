                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                          <p>
                                            ...
                                            <input type="date" name="limit_time" id="limit_time" class="form-control" required="" onkeydown="return false" value="{{date('Y-m-d', strtotime($ress['limit_time']))}}"/>
                                            <!-- <input type="text" class="form-control dateHour" data-mask="9999/99/99 99:99:99" name="limit_time" id="limit_time" value="">  -->
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
