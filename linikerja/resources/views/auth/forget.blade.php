                                                ...
                                                <div class="col-sm-4">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            <form action="{{ url('/sendForgetPass') }}" method="post">
                                                                <input type="hidden" name="token" value="{{$token}}">
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <input type="password" class="form-control form-control-success" id="password" name="password" placeholder="Kata Sandi Baru" required/>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        {{-- <input type="text" class="form-control form-control-danger" id="password" /> --}}
                                                                        <input type="password" class="form-control form-control-success" id="confirm_password" name="confirm_password" placeholder="Ketik Ulang Kata Sandi Baru"/>
                                                                        <div id="jQ-messages"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 text-right">
                                                                        ...
                                                                        <input id="btn_submit" type="submit" name="submit" id="submit" class="btn btn-primary text-right btn-sm" value="Kirim" disabled/>
                                ...
                                <script>
                                    $("#password, #confirm_password").on("keyup", function () {
                                        if ($("#password").val() == $("#confirm_password").val()) {
                                            ...
                                            $("#confirm_password").removeClass("form-control form-control-danger").addClass("form-control form-control-success");
                                            // $("#jQ-messages").html('<div class="col-form-label"></div>').css("color", "red");
                                        } else {
                                            $("#btn_submit").attr("disabled", true);
                                            $("#confirm_password").removeClass("form-control form-control-success").addClass("form-control form-control-danger");
                                            // $("#jQ-messages").html('<div class="col-form-label">kata sandi tidak sama</div>').css("color", "red");
                                        }
                                    });
                                </script>
